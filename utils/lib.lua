...
local DrawingLib = IsStudio and require(script.Drawing) or Drawing
...
-- Declare a variable to store the last selected button label
local LastSelectedTabLabel = nil
...
function Library:CreateWindow(...)
	...
	if typeof(Config.Size) ~= 'UDim2' then
		if Library.IsMobile then
			...
			Config.Size = UDim2.fromOffset(513, 700)
		end
	end
	...
	local WindowLabel = Library:CreateLabel({
		Position = UDim2.new(0.015, 0, 0.002, 0);
	...
	function Window:AddTab(Name)
		...
		TabButton.InputBegan:Connect(function(Input)
			if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
				if LastSelectedTabLabel and LastSelectedTabLabel ~= TabButtonLabel then
					LastSelectedTabLabel.TextColor3 = Color3.new(1, 1, 1) 
				end
				
				TabButtonLabel.TextColor3 = Library.AccentColor
				
				LastSelectedTabLabel = TabButtonLabel
...
if not IsStudio and getgenv().skip_getgenv_linoria ~= true then getgenv().Library = Library end
